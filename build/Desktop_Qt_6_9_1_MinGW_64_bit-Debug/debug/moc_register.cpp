...
template <> constexpr inline auto Register::qt_create_metaobjectdata<qt_meta_tag_ZN8RegisterE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "code",
        "Emailtext",
        "on_register_varifypushButton_clicked",
        "on_register_confirmpushButton_clicked",
        "on_register_cancelpushButton_clicked",
        "updateCodeButton"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'Reset_pwdhandleSendResult'
        ...
        // Slot 'sendCAPTCHA'
        QtMocHelpers::SlotData<void(QString, QString, QString)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 6 }, { QMetaType::QString, 7 }, { QMetaType::QString, 8 },
        }}),
        // Slot 'on_register_varifypushButton_clicked'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_register_confirmpushButton_clicked'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_register_cancelpushButton_clicked'
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->Reset_pwdhandleSendResult(); break;
        case 1: _t->handleSendResult((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->sendCAPTCHA((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        case 3: _t->on_register_varifypushButton_clicked(); break;
        case 4: _t->on_register_confirmpushButton_clicked(); break;
        case 5: _t->on_register_cancelpushButton_clicked(); break;
        case 6: _t->updateCodeButton(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Register::*)()>(_a, &Register::Reset_pwdhandleSendResult, 0))
            return;
    }
}
...
// SIGNAL 0
void Register::Reset_pwdhandleSendResult()
{
